...
class TjTouristAttractions extends IController {
    use Readxls;
    /**
     * @var \App\Model\TjTouristAttractions;
     */
    protected $model;
    ...
    function attractionUpdate() {
        ...
        $attraction_data = json_encode($attraction_data, JSON_UNESCAPED_UNICODE);
        $result = $this->model->attractionUpdate(intval($_POST['id']), $attraction_data);
    ...
    function _attractionFile() {
        $config = [
            ...
            'size' => '10M',
            'mimetype' => ['application/vnd.ms-excel', 'application/wps-office.xlsx', 'application/wps-office.xls'],
        ];
