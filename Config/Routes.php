...
$_ROUTES = [
    ...
    'manager/country/outbound/customer/update' => ['POST', 'ManageCountrywideOutbound', 'customerSourceUpdate', 'Middleware@manager'],
    'manager/country/outbound/exitport/update' => ['POST', 'ManageCountrywideOutbound', 'exitportUpdate', 'Middleware@manager'],
    'country/outbound' => ['GET', 'CountrywideOutbound', 'get', 'Middleware@normal'],
    'manager/country/inbound/insert' => ['POST', 'ManageCountrywideInbound', 'inboundInsert', 'Middleware@manager'],
    'manager/country/inbound/customer/update' => ['POST', 'ManageCountrywideInbound', 'customerSourceUpdate', 'Middleware@manager'],
    'manager/country/inbound/inbound-count/update' => ['POST', 'ManageCountrywideInbound', 'inboundCountUpdate', 'Middleware@manager'],
    'country/inbound' => ['GET', 'CountrywideInbound', 'get', 'Middleware@normal'],
    ...
    'analysis/tourist' => ['GET', 'FeatureAnalysis', 'tourist', 'Middleware@normal'],
    ...
    'analysis/spend' => ['GET', 'FeatureAnalysis', 'spend', 'Middleware@normal'],
    ...
    'analysis/focus' => ['GET', 'FeatureAnalysis', 'focus', 'Middleware@normal'],
    ...
    'analysis/supplyside' => ['GET', 'FeatureAnalysis', 'supplySide', 'Middleware@normal'],
    'manager/provinces/reception/insert' => ['POST', 'ManageProvinces', 'insert', 'Middleware@manager'],
    'manager/provinces/reception/update' => ['POST', 'ManageProvinces', 'receptionNumberUpdate', 'Middleware@manager'],
    'manager/provinces/list' => ['GET', 'ManageProvinces', 'getList', 'Middleware@manager'],
    'provinces/reception' => ['GET', 'Provinces', 'get', 'Middleware@normal'],
];